                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Doanh thu 7 ngày gần nhất</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                            	<%if(request.getAttribute("revenue") != null && (Double)request.getAttribute("revenueTo7Days") != 0){
                                            		double revenue = (Double)request.getAttribute("revenue");
                                            	%>
                                            	<%=revenue%>
                                            	<%}else{%>
                                            	<h6 style="color: red;">Chưa đủ dữ kiện để hiển thị</h6>
                                            	<%}%>
                                            </td>
                                            <td>
                                            	<%if(request.getAttribute("revenueTo7Days") != null && (Double)request.getAttribute("revenueTo7Days") != 0){
                                            		double revenueTo7Days = (Double)request.getAttribute("revenueTo7Days");
                                            	%>
                                            	<%=revenueTo7Days%>
                                            	<%}else{%>
                                            	<h6 style="color: red;">Chưa đủ dữ kiện để hiển thị</h6>

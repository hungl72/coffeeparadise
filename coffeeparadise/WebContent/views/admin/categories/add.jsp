            ...
            <div id="content">
				...
				<div class="container-fluid">
					<form action="<%=request.getContextPath()%>/categoriesadd" method="post">
						...
						%>
						<h4 style="color: purple;">Thêm danh mục thành công</h4>
						<%
							}else if(request.getAttribute("result").equals("-1")){
						%>
						<h4 style="color: red;">Thêm danh mục thất bại</h4>
						<%
							}else{}
						%>
	                    <input style="width: 30%;margin-bottom: 20px;" class="form-control bg-light border-2 small" type="text" name="name" placeholder="Nhập tên danh mục ..."/>
	                    <button class="btn btn-primary" style="margin-bottom: 25px;">Thêm danh mục</button>
                    </form>
                    <!-- DataTales Example -->
                </div>
                </div>

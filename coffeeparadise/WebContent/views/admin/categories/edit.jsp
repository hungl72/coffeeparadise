...
<div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<div class="container-fluid">
					<form action="<%=request.getContextPath()%>/categoriesedit" method="post">
						<%
							if(request.getAttribute("result").equals("1")){
						%>
						<h4 style="color: purple;">Sửa danh mục thành công</h4>
						<%
							}else if(request.getAttribute("result").equals("-1")){
						%>
						<h4 style="color: red;">Sửa danh mục thất bại</h4>
						<%
							}else{}
						%>
						<%
						...
						%>
						<input style="width: 30%;margin-bottom: 20px;" class="form-control bg-light border-2 small" type="text" name="id" value="<%=categories.getCategories_id()%>" readonly/>
	                    <input style="width: 30%;margin-bottom: 20px;" class="form-control bg-light border-2 small" type="text" name="name" value="<%=categories.getCategories_name()%>"/>
	                    <button class="btn btn-primary" style="margin-bottom: 25px;">Sửa danh mục</button>
	                    <%} %>
                    </form>
                    <!-- DataTales Example -->
                </div>

...
<h3 class=" text-center" style="font-weight: bold;">Trò chuyện với khách hàng</h3>
<div class="messaging">
      <div class="inbox_msg">
        <div class="inbox_people">
          <div class="headind_srch">
            <div class="recent_heading">
              <h4 style="font-weight: bold;">Online <span style="color: red;"><span class="online">0</span>/<span class="offline">0</span></span> </h4>
            </div>
            <div class="srch_bar">
          ...
          <form id="chat">
                 <div class="panel-footer">
                    <div class="input-group">
                        ...
                        <input id="id" type="hidden" name="id" value="<%=staff.getStaff_id()%>"/>
                        <input id="username" type="hidden" name="name" value="<%=staff.getStaff_name()%>"/>

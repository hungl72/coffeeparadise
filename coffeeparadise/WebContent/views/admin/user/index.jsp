...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <!-- /.container-fluid -->
    				...
    				%>
                        <a href="<%=request.getContextPath()%>/adminuser?page=<%=back%>">Trước</a>&nbsp;
                    <%
                          }
                    %>
                    <%
                        for(int i=1;i<=numberOfPages;i++){
                            if(currentPage==i){
                    %>
                        <a href="<%=request.getContextPath()%>/adminuser?page=<%=i%>"><%=i%></a>&nbsp;
                    <%
                            }else{
                    %>
                        <a href="<%=request.getContextPath()%>/adminuser?page=<%=i%>"><%=i%></a>&nbsp;
					...
					%>		
                        <a href="<%=request.getContextPath()%>/adminuser?page=<%=next%>">Sau</a>&nbsp;
                    <%
    						}
                        }
   					%>

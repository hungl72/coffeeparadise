                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
									...
									%>
                                        <tr>
                                            <td><%=s.getStaff_id()%></td>
                                            <td><img style="width: 250px;height: auto;" src="<%=request.getContextPath()%>/templates/admin/img/<%=s.getStaff_image()%>" /></td>
                                            <td><%=s.getStaff_name()%></td>
                                            <td><%=s.getStaff_email()%></td>
                                            <td><%=s.getStaff_phone()%></td>
                                            <td><%=s.getStaff_salary()%></td>
                                            <td><%=s.getStaff_calendar()%></td>
                                            <td style="width: 12%">
                                            <button class="btn btn-primary"><a style="color: #FFFFFF;text-decoration: none;" href="<%=request.getContextPath()%>/staffsedit?id=<%=s.getStaff_id()%>">Sửa</a></button>
                                            <button class="btn btn-primary"><a style="color: #FFFFFF;text-decoration: none;" href="<%=request.getContextPath()%>/staffsdel?id=<%=s.getStaff_id()%>" onclick="return confirm('Bạn có muốn xóa nhân viên này không ?')">Xóa</a></button></td>
                                        </tr>
                                        <%
                                        			}
                                    			}

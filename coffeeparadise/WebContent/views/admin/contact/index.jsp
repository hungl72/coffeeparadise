...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Quản lý góp ý</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
									...
									%>
                                        <tr>
                                            ...
                                            <td><%=contact.getContact_phone()%></td>
                                            <td><%=contact.getContact_title()%></td>
                                            <td><%=contact.getContact_content()%></td>
				...
				<div class="container">
    				...
    				%>
                        <a href="<%=request.getContextPath()%>/admincontact?page=<%=back%>">Trước</a>&nbsp;
                    <%
                          }
                    %>
                    <%
                        for(int i=1;i<=numberOfPages;i++){
                            if(currentPage==i){
                    %>
                        <a href="<%=request.getContextPath()%>/admincontact?page=<%=i%>"><%=i%></a>&nbsp;
                    <%
                            }else{
                    %>
                        <a href="<%=request.getContextPath()%>/admincontact?page=<%=i%>"><%=i%></a>&nbsp;
					...
					%>		
                        <a href="<%=request.getContextPath()%>/admincontact?page=<%=next%>">Sau</a>&nbsp;
                    <%
    						}
                        }
   					%>

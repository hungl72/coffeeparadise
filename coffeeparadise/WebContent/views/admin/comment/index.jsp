...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    %>
                                        <tr>
                                            ...
                                            <td><%=comment.getDetail()%></td>
                                            <td><%=comment.getProduct_name()%></td>
				...
				<div class="container">
    				...
    				%>
                        <a href="<%=request.getContextPath()%>/admincomment?page=<%=back%>">Trước</a>&nbsp;
                    <%
                          }
                    %>
                    <%
                        for(int i=1;i<=numberOfPages;i++){
                            if(currentPage==i){
                    %>
                        <a href="<%=request.getContextPath()%>/admincomment?page=<%=i%>"><%=i%></a>&nbsp;
                    <%
                            }else{
                    %>
                        <a href="<%=request.getContextPath()%>/admincomment?page=<%=i%>"><%=i%></a>&nbsp;
					...
					%>		
                        <a href="<%=request.getContextPath()%>/admincomment?page=<%=next%>">Sau</a>&nbsp;
                    <%
    						}
                        }
   					%>

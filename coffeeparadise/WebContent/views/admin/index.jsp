...
<body id="page-top">
    ...
    <%@ include file="/templates/admin/inc/leftbar.jsp" %>
        <div id="content-wrapper" class="d-flex flex-column">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div id="approval" class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                               Đơn hàng đã duyệt</div>
                                            <div id="approved" class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-box"></i>
                                        </div>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                               Đơn ship thành công</div>
                                            <div id ="ship" class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-box"></i>
                                        </div>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Biểu đồ doanh thu tuần</h6>
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="chart-area" style="height: 23rem;">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="<%=request.getContextPath()%>/templates/admin/img/undraw_posting_photo.svg" alt="">
                                    </div>
            ...
            <!-- End of Main Content -->
            <script>
            setInterval(autorevenue, 1000);
            setInterval(autoapproval, 1000);
            setInterval(autoapproved, 1000);
            setInterval(autoshipcomplete, 1000);
            function autorevenue(){
            	$.ajax({            
                    url: '<%=request.getContextPath()%>/autorevenue',
                    method: 'post',
                    data:{},
            ...
            function autoapproval(){
            	$.ajax({            
                    ...
                    data:{},
                    success:function(data){
                    	$('#approval').html(data+" Đơn");
                    }
                });
            }
            function autoapproved(){
            	$.ajax({            
                    url: '<%=request.getContextPath()%>/autorevenuee',
                    method: 'get',
                    data:{},
                    success:function(data){
                    	$('#approved').html(data+" Đơn");
                    }
                });
            }
            function autoshipcomplete(){
            	$.ajax({            
                    url: '<%=request.getContextPath()%>/autorevenuee',
                    method: 'post',
                    data:{},
